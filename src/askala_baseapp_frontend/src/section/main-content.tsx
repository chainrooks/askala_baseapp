    ...
    if (!selectedTopic) {
      return (
        <div className="text-center py-12">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-4">Welcome to Python Learning</h1>
          <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
            Select a topic from the sidebar to begin your Python learning journey. Our AI assistant will help you understand complex concepts through interactive conversations.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card>
              ...
              <CardContent>
                <CardDescription>Learn Python from basics to advanced concepts with hands-on examples</CardDescription>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <CardDescription>Ask questions about Python concepts and get detailed explanations</CardDescription>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <CardDescription>Interactive content with code examples, exercises, and best practices</CardDescription>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <CardDescription>Track your questions and learning progress for each topic</CardDescription>
              </CardContent>
            </Card>
          </div>
        </div>
  ...
  const renderContent = () => {
    ...
    return (
      <div className="text-center py-12">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-4">{selectedTopic.title}</h1>
        <p className="text-muted-foreground text-lg mb-8">{selectedTopic.description}</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">
              {selectedTopic ? selectedTopic.title : 'Python Learning Assistant'}
            </h1>
            <p className="text-sm text-muted-foreground">
              {selectedTopic ? selectedTopic.description : 'Master Python programming from basics to advanced concepts'}
            </p>
          </div>
        </div>
      </div>
