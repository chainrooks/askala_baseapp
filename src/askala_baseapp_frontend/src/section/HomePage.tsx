...
export const HomePage = () => {
  ...
  const fetchICPPrice = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to fetch ICP price data');
  ...
  return (
    <>
      ...
      <main className="flex flex-col min-h-screen bg-black">
            ...
            <div className="text-center">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-[#2A2D3B] to-[#3E3F4E] hover:bg-gradient-to-r hover:from-[#3E3F4E] hover:to-[#2A2D3B] transition duration-300 ease-in-out backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-8">
                ...
                <span className="text-sm font-medium text-white">
                  Leading AI Learning Platform
                </span>
              </div>
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Master Programming Languages With{' '}
                <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                  Askala AI
                </span>
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                Boost your programming skills with ease using our AI-powered
                learning platform, which uses advanced AI technology and an
                intuitive teaching method for all levels.
              </p>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-900/30 to-purple-900/30 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-500/20 mb-6">
                ...
                <span className="text-sm font-medium text-blue-300">Internet Computer Protocol</span>
              </div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Stay updated with real-time ICP prices and convert between ICP, USD, and IDR with our advanced calculator
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="text-sm font-medium text-gray-300">ICP/USD</h3>
                          <p className="text-xs text-gray-500">US Dollar</p>
                        </div>
                      </div>
                      <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${priceChange.usd >= 0 ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'
                        }`}>
                        <TrendingUp className={`w-3 h-3 ${priceChange.usd < 0 ? 'rotate-180' : ''}`} />
                  ...
                  <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-purple-500/30 transition-all duration-300">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="text-sm font-medium text-gray-300">ICP/IDR</h3>
                          <p className="text-xs text-gray-500">Indonesian Rupiah</p>
                        </div>
                      </div>
                      <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${priceChange.idr >= 0 ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'
                        }`}>
                        <TrendingUp className={`w-3 h-3 ${priceChange.idr < 0 ? 'rotate-180' : ''}`} />
                    ...
                    {loading ? (
                      ...
                      <div>
                        <p className="text-2xl font-bold text-white mb-2">
                          Rp {formatNumber(icpPrice.idr.toFixed(0))}
                        </p>
                        <p className="text-xs text-gray-500">
                          Last updated: {lastUpdated?.toLocaleTimeString()}
                        </p>
                ...
                <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-white">About Internet Computer (ICP)</h3>
                  </div>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Internet Computer (ICP) is a revolutionary blockchain network that enables developers to build and deploy smart contracts and decentralized applications directly on the internet.
                    ICP aims to extend the internet with secure, decentralized computing capabilities, making it possible to build entirely on-chain applications.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white">Currency Calculator</h3>
                </div>
                    ...
                    <div className="text-center">
                      ...
                      {loading ? (
                        ...
                        <p className="text-2xl font-bold text-white">
                          {formatCurrency(calculateConversion(), calculatorTo)}
                        </p>
                      )}
                      <p className="text-xs text-gray-500 mt-2">
                        {calculatorAmount} {calculatorFrom} = {calculateConversion()} {calculatorTo}
                      </p>
                    </div>
                  </div>
        ...
        <section className="py-8 bg-gradient-to-br from-[#0f1419] via-[#121826] to-[#1a1f2e] overflow-hidden relative">
          <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 px-8">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-[#58C2D6] via-[#6366f1] to-[#8b5cf6] bg-clip-text text-transparent mb-4">
                  Trending Courses
                </h1>
                <p className="text-[#8B9BB1] text-lg max-w-2xl">
                  Find popular courses that have been selected by thousands of students to improve AI and tech skills
                </p>
              </div>
            ...
            <div className="mx-auto px-4 max-w-7xl">
              <div className="relative overflow-hidden">
                <div
                  ...
                  style={{
                    transform: `translateX(-${currentSlide * (cardWidth + 32)
                      }px)`,
              ...
              {pricing.map((plan, index) => (
                ...
                >
                  ...
                  <div className="mt-auto">
                    <button
                      className={`w-full py-2 px-4 rounded-lg text-sm transition-all duration-200 ease-in-out ${plan.popular
              ...
              <div className="lg:w-1/4 space-y-4">
                {features.map((feature, index) => (
                  <button
                    ...
                    className={`w-full p-6 rounded-xl text-left transition-all duration-300 ${index === activeFeature
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div
                        className={`p-3 rounded-full ${index === activeFeature ? 'bg-white' : 'bg-gray-700'
                          }`}
                      >
                        {React.cloneElement(feature.icon, {
                          className: `w-5 h-5 ${index === activeFeature
                            ? 'text-gray-900'
                            : 'text-white'
                            }`
                        })}
                      ...
                      <h3
                        className={`text-lg font-medium ${index === activeFeature
                          ? 'text-black'
                          : 'text-gray-400'
                          }`}
                      >
